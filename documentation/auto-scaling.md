...
<html>
<head>
    <title>Secure AWS Web Application</title>
</head>
<body>
    <h1>Secure AWS Web Application</h1>
    <p>Deployed using AWS Auto Scaling.</p>
</body>
</html>
EOF

The User Data automatically installs and starts Nginx when a new EC2 instance is launched.
...
The Application Load Balancer distributes HTTP requests to healthy instances registered with the Target Group.
...
Enabled Nginx
Started Nginx
Created the application web page
